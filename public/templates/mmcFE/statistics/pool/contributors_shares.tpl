...
{section shares $CONTRIBSHARES}
      <tr{if $GLOBAL.userdata.username == $CONTRIBSHARES[shares].account}{assign var=listed value=1} style="background-color:#B8BEDC;"{else} class="{cycle values="odd,even"}"{/if}>
        <td>{$rank++}</td>
